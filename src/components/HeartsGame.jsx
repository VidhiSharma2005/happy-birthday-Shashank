...
export default function HeartsGame({ onComplete }) {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            if (spawned < TOTAL_HEARTS) {
                setHearts((prev) => [
                    ...prev.slice(-MAX_ACTIVE + 1), // keep max 20
                    {
                        id: Math.random(),
                        x: Math.random() * 90,
                        y: -10,
    ...
    return (
        ...
        >
            ...
            {/* Kitten catcher */}
            {/* <div
                className="absolute bottom-4 w-16 h-16 bg-yellow-300 rounded-full flex items-center justify-center text-3xl shadow-md"
...
>
  <img
    src="src/assets/boyfriend.png" // place your photo in public folder as boyfriend.png
    alt="Boyfriend"
